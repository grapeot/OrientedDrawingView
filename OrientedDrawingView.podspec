#
#  Be sure to run `pod spec lint OrientedDrawingView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Dennis Lysenko"
  # s.authors            = { "Dennis Lysenko" => "dennis.s.lysenko@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Dennis Lysenko"
  ...
  s.source       = { :git => "https://github.com/grapeot/OrientedDrawingView.git", :tag => "v0.0.6" }
  ...
  s.source_files  = "OrientedDrawingView/DrawingView.swift", "DrawingView.swift"
